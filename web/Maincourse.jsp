...
<div class="row" >
  ...
  <div class="card-body">
    ...
    <a href="Punjabi.jsp" class="btn btn-primary">Order Punjabi</a>
 </div>
</div>
     </div>
         <div class="col-sm-4">
  ...
  <div class="card-body">
    ...
    <a href="Veg.jsp" class="btn btn-primary">Order Veg</a>
  </div>
  </div>
  </div>
          <div class="col-sm-4">
  ...
  <div class="card-body">
    ...
    <a href="Rice.jsp" class="btn btn-primary">Order Rice</a>
  </div>
  </div>
  </div>
    <br>
  ...
  <div class="card-body">
    ...
    <a href="Roti.jsp" class="btn btn-primary">Order Roti</a>
  </div>
  </div>
  </div>
          <div class="col-sm-4">
  ...
  <div class="card-body">
    ...
    <a href="Dal.jsp" class="btn btn-primary">Order Dal</a>
  </div>
  </div>
  </div>
     </div>
